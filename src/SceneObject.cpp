...
SceneObject::SceneObject(const char *filename):hitbox(attrib)
{
...
void SceneObject::render(GpuProgramController& gpuProgramController)
{
    ...
    glBindVertexArray(0);
    /*drawHitbox(gpuProgramController);*/
...
/*    return;*/
/*  }*/
/*  std::cout<<"primeiro vertice: "<<attrib.vertices[0]<<" "<<attrib.vertices[1]<<" "<<attrib.vertices[2]<<std::endl;*/
...
/*    }*/
/**/
/*    hitboxMin = glm::vec3(model_matrix * glm::vec4(attrib.vertices[0], attrib.vertices[1], attrib.vertices[2], 1.0f) );*/
/*    hitboxMax = hitboxMin;*/
/*    for (size_t i = 0; i < attrib.vertices.size(); i += 3) {*/
/*        glm::vec3 vertex = glm::vec3(model_matrix * glm::vec4(attrib.vertices[i], attrib.vertices[i + 1], attrib.vertices[i + 2], 1.0f));*/
/*        hitboxMin = glm::min(hitboxMin, vertex);*/
/*        hitboxMax = glm::max(hitboxMax, vertex);*/
/*    }*/
/*}*/
...
/*void SceneObject::drawHitbox(GpuProgramController& gpuProgramController){*/
/*  calculateHitbox();*/
...
/*    };*/
/*    for(int i=0;i<8;i++){*/
/*      vertices[i]=glm::vec3(model_matrix*glm::vec4(vertices[i],1.0f));*/
/*    }*/
/*    GLuint indices[24] = {*/
/*        0, 1, 1, 2, 2, 3, 3, 0,*/
/*        4, 5, 5, 6, 6, 7, 7, 4,*/
